package com.company.hrtrainingplatform.web.filledsurvey

import com.company.hrtrainingplatform.entity.PossibleAnswer
import com.company.hrtrainingplatform.entity.SelectedAnswer
import com.company.hrtrainingplatform.entity.Survey
import com.haulmont.cuba.core.global.Metadata
import com.haulmont.cuba.gui.components.AbstractEditor
import com.company.hrtrainingplatform.entity.FilledSurvey
...
class FilledSurveyEdit extends AbstractEditor<FilledSurvey> {
    @Inject
    ...
    public void init(Map<String, Object> params) {
        ...
        answersTable.addGeneratedColumn("Answer", new Table.ColumnGenerator<SelectedAnswer>() {
            ...
            Component generateCell(SelectedAnswer entity) {
                ...
                optionsDs.setQuery('select e from hrtrainingplatform$PossibleAnswer e where e.question.id = :custom$question order by e.code asc')
