package com.company.hrtrainingplatform;
...
public class HrtrainingplatformTestContainer extends TestContainer {

    public HrtrainingplatformTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/hrtrainingplatform/app.properties",
    ...
    public static class Common extends HrtrainingplatformTestContainer {

        public static final HrtrainingplatformTestContainer.Common INSTANCE = new HrtrainingplatformTestContainer.Common();
